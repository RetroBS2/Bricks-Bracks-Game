class jogador{
  ...
  baterBola(ball){
    if((this.x <= ball.posicaoX+ball.raio/2 && this.x+this.largura >= ball.posicaoX-ball.raio/2) && (this.y <= ball.posicaoY + ball.raio/2) &&(ball.posicaoY+ball.raio/2<this.y+this.altura) && (ball.velocidadeY > 0)){
      ball.velocidadeY *= -1;
    }
  }
